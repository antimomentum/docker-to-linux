...
The Ubuntu and Debian images are now made for Linode compatibility (the created image also works in WSL2 and anything else that might support GRUB2). The files I've included to this are based on Linode documentation which I'll link below a summary of the instructions.
